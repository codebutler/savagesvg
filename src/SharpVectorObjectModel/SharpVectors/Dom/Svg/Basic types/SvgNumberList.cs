...
namespace SharpVectors.Dom.Svg
{
	...
	public class SvgNumberList : SvgList, ISvgNumberList
	{
		...
		public new ISvgNumber GetItem(uint index)
		{
			return (ISvgNumber) base.GetItem(index);
		}

		public ISvgNumber InsertItemBefore(ISvgNumber newItem, uint index)
		{
			return (ISvgNumber) base.InsertItemBefore(newItem, index);
		}

		public ISvgNumber ReplaceItem(ISvgNumber newItem, uint index)
		{
			return (ISvgNumber) base.ReplaceItem(newItem, index);
		}

		public new ISvgNumber RemoveItem(uint index)
		{
