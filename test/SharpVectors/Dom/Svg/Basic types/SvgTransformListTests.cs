...

{
	...
	public class SvgTransformListTests : SvgListTests

	{
        ...
        #region Additional SvgTransformList-specific tests
        ...
        */
        ...
        protected new SvgTransform makeItem()

        {

            string scale = (counter++).ToString();



            return new SvgTransform("matrix(" + scale + ",0,0," + scale + ",0,0");
