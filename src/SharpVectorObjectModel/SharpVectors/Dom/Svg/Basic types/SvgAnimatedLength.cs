...
namespace SharpVectors.Dom.Svg
{
	...
	public class SvgAnimatedLength : ISvgAnimatedLength
	{
		...
		{
			baseVal = new SvgLength(ownerElement, propertyName, SvgLengthSource.Xml, direction, defaultValue);
		}
		...
		{
			baseVal = new SvgLength(ownerElement, propertyName, direction, strValue, defaultValue);
		}
		#endregion
