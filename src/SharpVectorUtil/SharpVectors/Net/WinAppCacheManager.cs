...
{
	public class WinAppCacheManager : ICacheManager
	{
		private string cacheDir;
		private string cacheDocPath;
		private XmlDocument cacheDoc = new XmlDocument();

		public WinAppCacheManager()
		{
			cacheDir = Path.Combine(
				SharpVectors.ApplicationContext.ExecutableDirectory.FullName,
				"cache/");
		...
		public WinAppCacheManager(string cacheDir)
		{
